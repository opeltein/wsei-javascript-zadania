...
const personA = new Person('Tomasz', 'Opalski', 22, 'Poland', 'Kraków', 'polish');
const personB = new Person('Janusz', 'Korwin', 69, 'Poland', 'Warsaw', 'polish');
const personC = new Person('Andrzej', 'Duda', 56, 'Poland', 'Szczebrzeszyn', 'polish');
const personD = new Person('Sylwia', 'Wesołowska', 14, 'Poland', 'Gniezno', 'polish');
const personE = new Person('Ryszard', 'Kot', 30, 'Poland', 'Sopot', 'polish');
